  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/payroll/overtime', label: 'Horas Extras', icon: BarChart, show: canAdmin || canGestor || isUser },
        { to: '/payroll/income-reports', label: 'Informe de Rendimentos', icon: BarChart, show: canAdmin || canGestor || isUser },
      ],
    },
    {
      title: 'Configurações',
